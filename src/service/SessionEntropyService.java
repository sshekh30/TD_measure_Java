...
import model.*;
import model.EntropyObject;
import model.SessionEntropyData;
import parser.*;
...
public class SessionEntropyService {
    ...
    public SessionEntropyData getEntireSessionEntropy(String sessionId)
        throws IOException {
        return defaultResultStorage.readResults(sessionId);
    }
    ...
    public EntropyObject getEntropyForScenario(
        ...
        SessionEntropyData data = defaultResultStorage.readResults(sessionId);
    ...
    public void CalculateEntropy(String sessionID, String dataSourceType)
        ...
        EntropyObject sessionEntopy = new EntropyObject(sessionEntropyMap);
        ...
        resultStorageDAO.writeResults(sessionEntropyData);
    }
}
